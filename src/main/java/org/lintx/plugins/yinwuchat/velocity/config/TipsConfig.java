...
public class TipsConfig {
    ...
    @YamlConfig
    public String qqCooldownTip = "&c发送QQ消息太频繁，请等待 {time} 秒后再试";
    
    @YamlConfig
    public String qqSendSuccessTip = "&a消息已发送到QQ群";
    
    @YamlConfig
    public String qqSendFailTip = "&cQQ群消息发送失败，请稍后再试";
    
    @YamlConfig
    public String qqNotEnabledTip = "&cQQ群同步功能未启用";
}
